...
public class StudentRequestHandler implements Runnable{

    private Socket socket;

        public StudentRequestHandler(Socket socket) {
            this.socket = socket;
        }
    ...
    private void processRequest(Socket socket) throws IOException {
        ...
        boolean result = true;
        String message = "STUDENT ANSWER";
        try {
            StudentPerson person = buildPerson(sb.toString());
